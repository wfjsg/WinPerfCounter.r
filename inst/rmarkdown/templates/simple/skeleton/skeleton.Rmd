...
plotConfig <- list(
  ...
  eventVerticalLines = as.POSIXct(c(
    "2018/01/07 21:07:00", "2018/01/07 21:10:20"), format="%Y/%m/%d %H:%M:%OS"),
  eventRange = as.POSIXct(c(
    "2018/01/07 21:07:05", "2018/01/07 21:09:00",
    "2018/01/07 21:12:00", "2018/01/07 21:12:30"), format="%Y/%m/%d %H:%M:%OS")
  )
...
plotcpu_chart <- decorate(cpu_chart)
