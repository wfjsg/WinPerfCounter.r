...
processes <- list(
  explorer = list( 
       cpu.scale.auto = FALSE, cpu.min = 0, cpu.max = 100,
       memory.scale.auto = FALSE, memory.min = 0, memory.max = 0.25), 
  OneDrive = list( 
       cpu.scale.auto = FALSE, cpu.min = 0, cpu.max = 10,
       memory.scale.auto = FALSE, memory.min = 0, memory.max = 1)
)
...
cpu_chart <- WinPerfCounter.Process.PlotCPU(data, processes, sysenv.cpu.core, processName)
memory_chart <- WinPerfCounter.Process.PlotMemory(data, processes, sysenv.memory, processName)
```
