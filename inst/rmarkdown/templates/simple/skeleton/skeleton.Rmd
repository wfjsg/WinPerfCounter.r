...
decorate <- function(plot, ymin = 0.0, ymax = 100.0) {
  if( length(eventVerticalLines) > 1 ){
    plot <- plot + geom_vline(xintercept = eventVerticalLines, alpha = 0.4, color = "coral2")
  }
...
cpu_chart <- decorate(cpu_chart, 0, 100.0)
...
memory_chart <- decorate(memory_chart, 0, 100.0) 
