...
header %>% 
  ...
  # dplyr::mutate(Committed = cell_spec(Committed, "html", align = "l", color = "white")) %>% 
...
colorVector <- c("Image" = "#D8ADFF", "Mapped_File"  = "#B0D7FF", "Shareable"  = "#DDEEFF", "Heap" = "#FF9664", 
                 "Managed Heap" = "#D4E27A", "Stack" = "#FFC080", "Private_Data" = "#F4F400", "Page_Table" = "#D2A0A0", "Unusable" = "#D2D2D2")
gdata <- header %>% 
